...
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
	...
	<style>
		...
		*::before {
		...
		.banner {
			display: flex;
			background-image: url("https://multiliving-landing-page.s3.ap-south-1.amazonaws.com/bandra/primary.png");
			width: 100%;
...
@media (max-width: 940px) {
    ...
    .banner-right {
		...
		.section-3-background {
			...
			background-size: contain;
			background-repeat: no-repeat;
			background-image: url("https://multiliving-landing-page.s3.ap-south-1.amazonaws.com/bandra/main-bg.png");
		}
        .input-inline {
            width: 100%;
				display: flex;
			...
			<div class="container">
                ...
                <div class="input-inline">
                        ...
                        <div class="input-inline-start">
                            <input type="checkbox" name="sure" placeholder="select" checked="checked" required class="check-me" />
			...
			<div class="container">
				...
				<div class="banner-text">
					<div class="banner-left">
						...
						<h2>
							Exclusive Rental Homes In Bandra West.
						</h2>
	...
	<div class="section-12">
		<div class="container">
			<div class="wrapper">
				<div class="left">
					<h3 class="heading">
						Finding rental homes in Bandra doesn’t get any easier than this!</h3>
